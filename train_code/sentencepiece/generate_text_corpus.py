# -*- coding: utf-8 -*-
"""
Created on Thu Jan 25 23:47:46 2024
...
class CorpusCreator:
    ...
    def create_sentence_corpus(
        ...
        text_col,
        dataset_split="train",
        output_file_name="swahili_sentence_corpus.txt",
    ):
        try:
    ...
    def run(self):
        ...
        parser.add_argument(
            "--output-file-name",
            default="swahili_sentence_corpus.txt",
            help="Name of the output corpus file (default: 'swahili_sentence_corpus.txt').",
        )
